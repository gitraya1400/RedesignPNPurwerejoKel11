      ...
      <div className="bg-gradient-to-br from-[#9A2109] to-[#7A1A07] pt-24 pb-0">
        <div className="max-w-[1440px] mx-auto px-8 pt-6 pb-0">
          ...
          <div className="max-w-2xl mb-8">
            <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-3 py-1.5 text-xs text-[#F9C784] font-semibold mb-4">
              <Award size={12} />
        ...
        <div className="grid grid-cols-3 gap-5">
          {summaryCards.map(({ icon: Icon, label, value, sub, color, bg }) => (
            ...
            >
              ...
              <div>
                <p className="text-[11px] text-[#64748B] font-semibold uppercase tracking-wide mb-1">{label}</p>
        ...
        <div className="grid grid-cols-[1fr_320px] gap-8 items-start">
          ...
          <div className="space-y-0">
            <div className="bg-white rounded-2xl border border-[#E2E8F0] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05)] overflow-hidden">
              <div className="px-7 py-5 border-b border-[#F1F5F9] bg-[#F8FAFC]">
                ...
                <p className="text-xs text-[#64748B] mt-0.5">Ikuti langkah-langkah berikut secara berurutan</p>
              </div>
                    ...
                    <div key={step.num} className="px-7 py-6 flex gap-5">
                      ...
                      <div className="flex-1 pb-2">
                        <div className="flex items-center gap-2.5 mb-2">
                          ...
                          <h3 className="text-sm font-bold text-[#1E293B]">{step.title}</h3>
                        </div>

                        <p className="text-sm text-[#475569] leading-relaxed mb-3">{step.description}</p>

                        {step.highlight && (
                          <div className="inline-flex items-center gap-2 bg-[#DCFCE7] border border-[#86EFAC] text-[#15803D] text-xs font-bold px-3 py-1.5 rounded-full mb-3">
                        ...
                        {step.tags.length > 0 && (
                          <div className="flex flex-wrap gap-2 mb-3">
                            {step.tags.map((tag) => (
                              <span
                                key={tag}
                                className="text-xs bg-[#F1F5F9] text-[#475569] border border-[#E2E8F0] px-2.5 py-1 rounded-full font-medium"
                              >
                                {tag}
                              </span>
                            ))}
                        ...
                        {step.cta && (
                          <a
                            href={step.cta.href}
                            className="inline-flex items-center gap-2 text-xs font-semibold text-[#9A2109] hover:text-[#7A1A07] bg-[#FFF1F1] hover:bg-[#FEE2E2] border border-[#FECACA] px-3.5 py-2 rounded-lg transition-all"
                          >
          ...
          <div className="sticky top-24 space-y-5">
            ...
            <div className="bg-gradient-to-br from-[#9A2109] to-[#7A1A07] rounded-2xl p-6 text-white shadow-lg">
              ...
              <p className="text-xs text-white/60 font-semibold uppercase tracking-wide mb-1">Butuh Bantuan?</p>
              ...
              <div className="space-y-2.5">
                <Link
                  to="/hubungi/posbakum"
                  className="flex items-center justify-center gap-2 bg-white text-[#9A2109] text-xs font-bold px-4 py-2.5 rounded-full hover:bg-[#F9C784] transition-colors"
                >
                  <ArrowRight size={13} />
                  Daftar Konsultasi POSBAKUM Online
                </Link>
                <button className="w-full text-center text-xs text-white/70 hover:text-white py-1.5 transition-colors">
            ...
            <div className="bg-white rounded-2xl border border-[#E2E8F0] p-5 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05)]">
              <h3 className="text-sm font-bold text-[#1E293B] mb-4">Tautan Berguna</h3>
              <div className="space-y-2">
                {[
                  ...
                  >
                    <div>
                      <p className="text-xs font-semibold text-[#1E293B] group-hover:text-[#9A2109] transition-colors">{label}</p>
            ...
            <div className="bg-[#EFF6FF] border border-[#BFDBFE] rounded-2xl p-5">
              <p className="text-xs font-bold text-[#1D4ED8] uppercase tracking-wide mb-2">Layanan Online</p>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-[#1D4ED8] text-white text-xs font-bold px-4 py-2 rounded-full hover:bg-[#1E40AF] transition-colors"
              >
                Buka e-Court
