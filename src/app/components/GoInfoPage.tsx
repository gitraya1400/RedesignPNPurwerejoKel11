      ...
      <div className="pt-24 pb-10" style={{ background: "linear-gradient(135deg,#9A2109 0%,#7B1A07 60%,#4A0E04 100%)" }}>
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-[#F9C784] text-xs mb-1 tracking-wide" style={{ fontWeight: 600 }}>HUBUNGI KAMI · LAYANAN INFORMASI PUBLIK</p>
        ...
        {submitted ? (
          ...
          <div className="grid lg:grid-cols-3 gap-6 items-start">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
                ...
                <div className="px-6 py-4 flex items-center gap-3" style={{ backgroundColor: "#9A2109" }}>
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-xs">Sampaikan permohonan informasi publik Anda secara online</p>
                  </div>
                </div>

                {/* Info strip */}
                <div className="mx-6 mt-5 bg-blue-50 border border-blue-200 rounded-xl px-4 py-3 text-xs text-blue-800" style={{ lineHeight: 1.65 }}>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                  ...
                  {errors.identitas && <p className="text-xs text-red-500 -mt-4 flex items-center gap-1"><AlertCircle size={12} />{errors.identitas}</p>}
                  ...
                  {errors.permohonan && <p className="text-xs text-red-500 -mt-4 flex items-center gap-1"><AlertCircle size={12} />{errors.permohonan}</p>}
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
                <div className="px-5 py-4 border-b border-gray-50">
                  <h3 className="text-gray-800" style={{ fontWeight: 700, fontSize: "0.95rem" }}>Informasi yang Tersedia</h3>
                </div>
